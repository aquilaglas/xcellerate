...
<div use:clickOutside onclickoutside={() => isOpen = false} class="relative">
    <button class="flex items-center rounded-4xl py-1 px-2"
    ...
    {#if isOpen}
        <div class="absolute z-10 w-fit mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
