...
<div class="w-full">
    <div class="fixed flex flex-col gap-2 top-0 w-full h-fit z-50 px-2 py-4 bg-white border-b-4 border-black">
    ...
    {:else}
        <div class="grid grid-cols-auto sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 xl:grid-cols-7 gap-4 p-4 pt-44">
